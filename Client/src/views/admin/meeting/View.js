                        ...
                        <GridItem colSpan={{ base: 4 }}>
                            <Card>
                                <Grid gap={4}>
                                    ...
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Meeting Type </Text>
                                        <Text>{data?.meetingType ? data?.meetingType : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Status </Text>
                                        <Text>{data?.status ? data?.status : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Priority </Text>
                                        <Text>{data?.priority ? data?.priority : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Meeting URL </Text>
                                        <Text>{data?.meetingUrl ? data?.meetingUrl : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> End Date Time </Text>
                                        <Text> {data?.endDateTime ? moment(data?.endDateTime).format('DD-MM-YYYY  h:mma ') : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Follow Up Required </Text>
                                        <Text>{data?.followUpRequired ? 'Yes' : 'No'}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Follow Up Date </Text>
                                        <Text> {data?.followUpDate ? moment(data?.followUpDate).format('DD-MM-YYYY') : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                    ...
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Outcome </Text>
                                        <Text>{data?.outcome ? data?.outcome : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
